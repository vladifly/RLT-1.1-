...
лежать вся папка проекта с файлами. Войдите в эту папку, далее войдите в out, artifacts, Russian_Language_Training. Вам откроются файлы, среди которых только 1
будет с расширением .exe. RLT [1.1] play.exe. Откройте его. Игра запустилась.

<img width="303" height="171" alt="Screenshot_6" src="https://github.com/user-attachments/assets/07191c9c-e295-45bc-9d58-38b6d596df15" />
